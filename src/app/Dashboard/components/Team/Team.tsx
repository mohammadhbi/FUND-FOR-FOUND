    ...
    <div>
        <div>
            <div className="flex gap-3">
                <div className="mt-2 w-3 h-3 bg-[var(--color-primary)]"></div>
                <p>Team</p>
            </div>
            <div className="pt-1.5">
                <p className="text-gray-500"><span className="text-xl text-black">Admins</span> can edit settings,approve expenses,and recive activity notifications(such as when a new expens is submitted).They are the active manegers of a collective.</p>
                <p className="text-gray-500 mt-1.5"> <span className="text-xl text-black">Teammate</span> are shown as port of the team on your page but do not have admin access or get notifications. They have profile page on the platform.</p>
            </div>
        </div>
      ...
      <div className="flex gap-4 flex-wrap">
        {teams.map((team) => {
          return (
            <div
              key={team.id}
              className="w-60 h-90 border border-gray-300  rounded-md flex flex-col items-center  shadow relative"
            >
            ...
            <div className="w-60 h-90 border border-gray-300 rounded-md flex flex-col items-center bg-white shadow">
        <div className="w-full h-6 bg-[var(--color-primary)] rounded-t"></div>
