...
// //   <div className="flex justify-start gap-x-32 border-b border-b-[var(--color-primary)] md:pr-[33.33%] sm:justify-center">
...
// //     </ul>
// //   </div>
// //   <div className="md:flex md:items-center md:justify-between sm:flex sm:items-center sm:gap-y-4">
...
// //     </ul>
// //     <Image src={socialIcons} alt="social" width={120} height={8} className="sm:order-1 sm:pb-4 md:pb-0" />
// //   </div>
// // </footer>
// //     </div>
// //   );
...
//       <ul key={index} className="flex flex-col gap-2.5 text-center min-w-[100px]">
//         {section.map((item) => (
//           <li key={item.href} className="text-medium whitespace-nowrap">
//             <Link
//               href={item.href}
...
//       {/* بخش پایین */}
//       <div className="flex justify-between items-center md:flex md:justify-between md:items-center sm:flex sm:items-center sm:gap-y-4 mt-5">
//         <div className="hidden sm:block">
//           <button className="p-2.5">
//             <p>English (100%)</p>
//           </button>
//         </div>
//         <ul className="flex gap-x-2.5 justify-center">
//           <li>Trust & safety</li>
//           <li>Terms of use</li>
//           <li>Privacy Policy</li>
//         </ul>
